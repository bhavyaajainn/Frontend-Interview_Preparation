...
function test(name, actual, expected) {
  ...
  const normalise = (arr) =>
    [...arr]
      .map((obj) => ({ ...obj, [Object.keys(obj).find((k) => Array.isArray(obj[k]))]: [...obj[Object.keys(obj).find((k) => Array.isArray(obj[k]))]]
          .sort() }))
      .sort((a, b) => {
...
test(
  'TC5: empty array returns []',
  aggregate([], 'skill', 'user'),
  []
);
